...
package br.com.realityup.wavebe.decoding;
...
import br.com.realityup.wavebe.BridgeR;
import br.com.realityup.wavebe.WavebeCaptureActivity;
import br.com.realityup.wavebe.camera.CameraManager;
import br.com.realityup.wavebe.view.ViewfinderResultPointCallback;
 ...
 */
public final class WavebeCaptureActivityHandler extends Handler {

  private static final String TAG = WavebeCaptureActivityHandler.class.getSimpleName();

  private final WavebeCaptureActivity activity;
  ...
  public WavebeCaptureActivityHandler(WavebeCaptureActivity activity, Vector<BarcodeFormat> decodeFormats,
      String characterSet) {

...
import br.com.realityup.wavebe.decoding.InactivityTimer;
import br.com.realityup.wavebe.decoding.WavebeCaptureActivityHandler;
import br.com.realityup.wavebe.view.ViewfinderView;

import com.google.zxing.BarcodeFormat;
import com.google.zxing.Result;

public class WavebeCaptureActivity extends Activity implements Callback {

	private WavebeCaptureActivityHandler handler;
	...
	private void initCamera(SurfaceHolder surfaceHolder) {
		...
		if (handler == null) {
			handler = new WavebeCaptureActivityHandler(this, decodeFormats,
					characterSet);
		}
	}
